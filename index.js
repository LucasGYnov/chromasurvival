   ...
   1: {
      ...
      init: () => {
            ...
            row.forEach((symbol, x) => {
               ...
               switch (symbol) {
                  ...
                  case 776:
                     ...
                     break;
                  case 11:
                     qgPlatform.push(new Platform({
                        position,
                        color: TRANSPARENT_COLOR
                     }));
                     break;
                  case 241:
                     enemySpawn.push(new Platform({
                        position,
                        color: TRANSPARENT_COLOR
                     }));
                     break;
         ...
         killBlock_tuto.forEach((symbol, index) => {
            ...
            if (symbol === 71) {
               killPlatform.push(new Platform({
                  position,
                  color: TRANSPARENT_COLOR
               }));
            }
            ...
            row.forEach((symbol, x) => {
               ...
               switch (symbol) {
                  ...
                  case 241:
                     ...
                     break;
                  case 565:
                     bouncePlatform.push(new Platform({
                        position,
                        color: TRANSPARENT_COLOR
                     }));
                  default:
